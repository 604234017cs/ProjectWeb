...
$message = '';
if (isset($_POST['Dir_Name']) && isset($_POST['P_Name']) && isset($_POST['Tell']) && isset($_POST['Username']) ){
    ...
    $sql = "UPDATE participants SET Dir_Name=?, P_Name=?,  Tell=? , Username=?  WHERE P_ID=?";
    $statement = $conn->prepare($sql);
    if($statement->execute([$Dir_Name, $P_Name, $Tell, $Username, $P_ID]))   {
    ...
    <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800">แก้ไขข้อมูลผู้เข้าอบรม</h1>
            ...
            <form action="" method="post" class="form-horizontal">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input value="<?= $participantss->Dir_Name; ?>" type="text" name="Dir_Name" id="Dir_Name" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input value="<?= $participantss->P_Name; ?>" type="text" name="P_Name" id="_Name" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input value="<?= $participantss->Tell; ?>" type="text" name="Tell" id="Tell" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input value="<?= $participantss->Username; ?>" type="text" name="Username" id="Username" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <input value="<?= $participantss->Password; ?>" type="password" name="Password" id="Password" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <button type="submit" name="btn_insert" class="btn btn-success" value="Insert">แก้ไขข้อมูลผู้เข้าอบรม</button>
